...
<div class='row'>
    <div class='col-xs-12 col-sm-4 col-sm-offset-1 text-center pad-top-20 vcenter'>
        <img class='img img-responsive img-center' src='../img/JL_John_And_Lena_1440x1440_001.png' height='450px' width='450px'>
    </div><!--
